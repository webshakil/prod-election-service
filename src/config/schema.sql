...
-- CREATE TABLE votteryy_elections (
...
--   CONSTRAINT fk_election_regional FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE,
...
--   CONSTRAINT fk_election_question FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE
-- );
...
--   CONSTRAINT fk_question_option FOREIGN KEY (question_id) REFERENCES votteryy_election_questions(id) ON DELETE CASCADE
-- );
...
--   CONSTRAINT fk_access_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE
-- );
...
--   CONSTRAINT fk_custom_url_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE
-- );
...
--   CONSTRAINT fk_setting_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE,
...
--   CONSTRAINT fk_mapping_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE,
--   CONSTRAINT fk_mapping_category FOREIGN KEY (category_id) REFERENCES votteryy_election_categories(id) ON DELETE CASCADE,
...
-- CREATE INDEX idx_elections_creator ON votteryy_elections(creator_id);
-- CREATE INDEX idx_elections_status ON votteryy_elections(status);
-- CREATE INDEX idx_elections_slug ON votteryy_elections(slug);
-- CREATE INDEX idx_elections_dates ON votteryy_elections(start_date, end_date);
-- CREATE INDEX idx_elections_creator_type ON votteryy_elections(creator_type);
-- CREATE INDEX idx_elections_org ON votteryy_elections(organization_id) WHERE organization_id IS NOT NULL;
...
-- -- Insert regional pricing defaults (example)
-- -- These can be used as templates for new elections
...
CREATE TABLE votteryy_election_lottery_config (
  ...
  CONSTRAINT fk_lottery_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE,
  UNIQUE(election_id)
);
...
CREATE TABLE votteryy_election_lottery_winners (
  ...
  CONSTRAINT fk_lottery_winner_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE,
...
--   CONSTRAINT fk_vote_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE,
--   CONSTRAINT fk_vote_user FOREIGN KEY (user_id) REFERENCES votteryy_user_details(id) ON DELETE CASCADE,
--   CONSTRAINT fk_vote_question FOREIGN KEY (question_id) REFERENCES votteryy_election_questions(id) ON DELETE CASCADE,
--   CONSTRAINT fk_vote_option FOREIGN KEY (option_id) REFERENCES votteryy_election_options(id) ON DELETE CASCADE,
...
--   CONSTRAINT fk_icon_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE
-- );
...
--   CONSTRAINT fk_otl_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE
-- );
...
--   CONSTRAINT fk_revenue_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE
-- );
...
--   CONSTRAINT fk_security_election FOREIGN KEY (election_id) REFERENCES votteryy_elections(id) ON DELETE CASCADE,
--   UNIQUE(election_id)
-- );
