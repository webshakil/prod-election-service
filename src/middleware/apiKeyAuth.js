...
const apiKeyAuth = async (req, res, next) => {
  ...
  try {
    ...
    // ✅ NEW: Extract and attach user/organization IDs for filtering
    req.userId = keyData.user_id || null;
    req.organizationId = keyData.organization_id || null;
...
//last successful code only to add all election by indiviual creator above code
// // src/middleware/apiKeyAuth.js
