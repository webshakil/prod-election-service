...
//last workable codes. just to implement questions saving above code
// import pool from '../config/database.js';
// import { generateUniqueSlug, validateDates, generateShareableUrl } from '../utils/helpers.js';
// import { ELECTION_STATUS, CREATOR_TYPES } from '../config/constants.js';
...
// export default new ElectionService();
//last workable code only to add anonymous voting above code
// import pool from '../config/database.js';
// import { generateUniqueSlug, validateDates, generateShareableUrl } from '../utils/helpers.js';
// import { ELECTION_STATUS, CREATOR_TYPES } from '../config/constants.js';
...
//         lottery_config?.total_prize_pool ? parseFloat(lottery_config.total_prize_pool) : null, // $34 lottery_total_prize_pool
//         lottery_config?.prize_description || null,                // $35 lottery_prize_description
//         lottery_config?.estimated_value ? parseFloat(lottery_config.estimated_value) : null, // $36 lottery_estimated_value
//         lottery_config?.projected_revenue ? parseFloat(lottery_config.projected_revenue) : null, // $37 lottery_projected_revenue
//         lottery_config?.revenue_share_percentage ? parseFloat(lottery_config.revenue_share_percentage) : null, // $38 lottery_revenue_share_percentage
//         lottery_config?.winner_count ? parseInt(lottery_config.winner_count) : 1, // $39 lottery_winner_count
//         lottery_config?.prize_distribution ? JSON.stringify(lottery_config.prize_distribution) : null, // $40 lottery_prize_distribution
...
//         lottery_prize_funding_source: electionValues[31],
//         lottery_reward_type: electionValues[32],
...
//this is last workable perfect code just to promote voter auto above code
// import pool from '../config/database.js';
// import { generateUniqueSlug, validateDates, generateShareableUrl } from '../utils/helpers.js';
// import { ELECTION_STATUS, CREATOR_TYPES } from '../config/constants.js';
...
//         // Pricing ($19-$22)
//         // mergedData.pricing_type === 'free',                       // $19 is_free
//         // mergedData.pricing_type || 'free',                        // $20 pricing_type
//         // parseFloat(mergedData.general_participation_fee) || 0,    // $21
//         // parseFloat(mergedData.processing_fee_percentage) || 0,    // $22
//         (mergedData.pricing_type === 'free' || parseFloat(mergedData.general_participation_fee || 0) === 0), // $19 is_free
